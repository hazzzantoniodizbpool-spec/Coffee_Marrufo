...
{
    /**
     * Muestra el dashboard principal con los datos iniciales
     */
    function index()
    {
        $datos = array();
    ...
    /**
     * Obtiene el total de ventas y tendencias por producto y canal
     */
    function total_ventas(Request $r)
    {
        ...
        if (isset($context['canal']) && $context['canal'] != '') {
    ...
    /**
     * Obtiene las ventas por producto (top, bottom y tendencias)
     */
    ...
    /**
     * Obtiene las ventas por categoría, filtrado por género
     */
    ...
    /**
     * Obtiene distribución demográfica por género
     */
     ...
     * Obtiene distribución demográfica por edades
     */
    ...
    /**
     * Obtiene ventas por producto filtrado por género
     */
    function ventas_producto_genero(Request $r)
    {
        ...
        $resultado = new \stdClass();
        $resultado = $servicio->ventas_producto_genero($objeto);
